  ...
  return (
    <AppLayout>
      <div className="mx-auto max-w-4xl">
        <div className="mb-6">
          <a href="/customers" className="text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Customer Master / New</a>
          <h1 className="mt-2 text-3xl font-bold" style={{ color: NAVY }}>Add Customer</h1>
          <p className="mt-1 text-sm text-slate-500">Create a reusable customer account for booking operations.</p>
        </div>
        <form onSubmit={saveCustomer} className="space-y-4">
          ...
          <div className="flex justify-end gap-2">
            ...
            <button type="submit" className="h-[42px] rounded-xl px-5 text-sm font-semibold text-white" style={{ backgroundColor: ORANGE }}>Save Customer</button>
          </div>
        </form>
      </div>
    </AppLayout>
